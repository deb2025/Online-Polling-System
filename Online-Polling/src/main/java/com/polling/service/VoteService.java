...
public class VoteService {
    ...
    public String castVote(String username, Long pollId, String selectedOption) {
        ...
        // Debugging: Print stored options
        System.out.println("Available options in poll: " + poll.getOptions());
        System.out.println("User selected option: " + selectedOption);

        // Validate option correctly
