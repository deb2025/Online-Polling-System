...
public class JwtUtil {
    ...
    private final String SECRET_KEY = "z1MV9NzzEQeieBhXBa3+oJDDItd9UgWAM1w77BfB3N8="; // Use a more secure key

    // Method to generate the JWT token
    public String generateToken(String username, String role) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("roles",role); // Ensure role is prefixed with 'ROLE_'
